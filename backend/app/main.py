...
app.include_router(premium.router, prefix="/api/v1/premium", tags=["Premium & Loyalty"])
app.include_router(ai_consultant.router, prefix="/api/v1/ai", tags=["AI Consultant"])
