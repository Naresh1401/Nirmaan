      ...
      <div className="bg-gradient-to-br from-blue-700 to-indigo-800 text-white py-12">
        <div className="max-w-7xl mx-auto px-4">
          ...
          <div className="flex flex-col sm:flex-row gap-3">
            ...
            {isAuthenticated && (
              <button onClick={() => showToast('Project posting form coming soon! 📋')} className="flex items-center gap-2 bg-white text-blue-700 font-bold px-5 py-2.5 rounded-xl hover:bg-blue-50 transition-all text-sm">
            ...
            <div key={project.id} className="bg-white rounded-2xl border border-gray-100 shadow-sm hover:shadow-md transition-all overflow-hidden">
              <div className="p-5">
                ...
                <div className="flex items-center justify-between pt-3 border-t border-gray-100">
                  ...
                  {isAuthenticated ? (
                    <button onClick={() => showToast(`Bid placed on "${project.title}"! 🎉`)} className="bg-blue-600 hover:bg-blue-700 text-white font-bold text-sm px-4 py-2 rounded-xl transition-all flex items-center gap-1.5">
